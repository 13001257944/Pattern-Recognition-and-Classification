...
M_class1 = np.matrix([[8.0], [7.0], [11.0]])
M_class2 = np.matrix([[-13], [-2], [-4]])
...
def class_accuracy(M1, M2, cov1,cov2,x11_test,x12_test,x13_test,x21_test,x22_test,x23_test):
    ...
    #running loop 10 times for 10X validation
    for j in range(0, 10):
...
def main():
    ...
    ### Answer e ###
    ### Genrate 200 new points for each class and Test classification accuracy using 10 fold method

    x11_test, x12_test, x13_test = generate_points(cov_class1, M_class1)
    x21_test, x22_test, x23_test = generate_points(cov_class2, M_class2)

    class_accuracy( Mean_class1_ML_est, Mean_class2_ML_est, Cov_class1_ML_est, Cov_class2_ML_est, x11_test, x12_test, x13_test, x21_test, x22_test, x23_test)
    class_accuracy(Mean_class1_BM_est, Mean_class2_BM_est, Cov_class1_BM_est, Cov_class2_BM_est, x11_test, x12_test, x13_test, x21_test, x22_test, x23_test)
